...
const CollectorGroupsStore = Reflux.createStore({
  listenables: [CollectorGroupsActions],
  ...
  list() {
    ...
    CollectorGroupsActions.list.promise(promise);
  },
  ...
  listTags() {
    ...
    CollectorGroupsActions.listTags.promise(promise);
  },
  ...
  getConfiguration(configurationId) {
    ...
    CollectorGroupsActions.getConfiguration.promise(promise);
  },
  ...
  createConfiguration(name) {
    ...
    CollectorGroupsActions.createConfiguration.promise(promise);
  },
  ...
  updateConfiguration(newConfiguration) {
    ...
    CollectorGroupsActions.updateConfiguration.promise(promise);
  },
  ...
  saveTags(tags, configurationId) {
    ...
    CollectorGroupsActions.saveInput.promise(promise);
  },
  ...
  saveOutput(output, configurationId) {
    ...
    CollectorGroupsActions.saveOutput.promise(promise);
  },
  ...
  saveSnippet(snippet, configurationId) {
    ...
    CollectorGroupsActions.saveSnippet.promise(promise);
  },
  ...
  copyConfiguration(configurationId, name) {
    ...
    CollectorGroupsActions.copyConfiguration.promise(promise);
  },
  ...
  copyOutput(outputId, name, configurationId) {
    ...
    CollectorGroupsActions.copyOutput.promise(promise);
  },
  ...
  copyInput(inputId, name, configurationId) {
    ...
    CollectorGroupsActions.copyInput.promise(promise);
  },
  ...
  copySnippet(snippetId, name, configurationId) {
    ...
    CollectorGroupsActions.copySnippet.promise(promise);
  },
  ...
  delete(configuration) {
    ...
    CollectorGroupsActions.delete.promise(promise);
  },
  ...
  deleteOutput(output, configurationId) {
    ...
    CollectorGroupsActions.deleteOutput.promise(promise);
  },
  ...
  deleteSnippet(snippet, configurationId) {
    ...
    CollectorGroupsActions.deleteSnippet.promise(promise);
  },
  ...
  deleteInput(input, configurationId) {
    ...
    CollectorGroupsActions.deleteInput.promise(promise);
  },
  ...
  updateTags(tags, configurationId) {
    ...
    CollectorGroupsActions.updateTags.promise(promise);
  },

});

export default CollectorGroupsStore;
